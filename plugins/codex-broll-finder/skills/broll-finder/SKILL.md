...
8. **Export and validate**: create requested platform variants, run `validate-export`, and include `BROLL-VALIDATION.json` plus `BROLL-VALIDATION.md` with the handoff.
...
```bash
python3 broll-finder/scripts/broll_tool.py --help
```
